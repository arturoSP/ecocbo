...
```{r step21}
cboCost <- sim_cbo(comp.var = compVar, multSE = NULL, budget = 20000, a = 3, ca = 2500, cn = 100)
cboCost

```

```{r step22}
cboPrecision <- sim_cbo(comp.var = compVar, multSE = 0.15, cn = 150)
cboPrecision
...
```{r step4}
plot_power(data = betaResult, n = NULL, method = "both")
